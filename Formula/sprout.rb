class Sprout < Formula
  ...
  url "https://github.com/mywyau/sprout/releases/download/v0.2.5/sprout-0.2.5.tar.gz"
  sha256 "d8fec77b962a6b1c5664502bfe417753a3d00ebb57eb375d8c220fcd0717acfd"
  license "MIT"
  ...
  test do
    assert_match "Sprout 0.2.5", shell_output("#{bin}/sprout --version")
